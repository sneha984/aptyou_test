...
class HomePage extends StatefulWidget {
  ...
  @override
  State<HomePage> createState() => _ReviewScreenState();
}

class _ReviewScreenState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    context.read<ReviewBloc>().add(LoadAssets());
  }
                ...
                child: Padding(
                  ...
                  child: AnimatedSwitcher(
                    ...
                    child: GridView.count(
                      ...
                      childAspectRatio: 1,
                      children:
                          List.generate(state.currentLetters.length, (index) {
                        ...
                        return AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            final scale =
                                highlight && state.targetLetter == letter
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: highlight && state.targetLetter == letter
                                  ? Colors.yellowAccent
                                  : Colors.white,
                            ),
